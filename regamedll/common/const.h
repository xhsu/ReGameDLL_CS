...
#define SF_NORESPAWN				BIT(30)	// set this bit on guns and stuff that should never respawn.
...
// CBaseEntity::TakeDamage() @param bitsDamageTypes values.
...
// CBaseEntity::Killed() @param iGib values
// When calling KILLED(), a value that governs gib behavior is expected to be
// one of these three values
enum class EEntityGib : BYTE
{
	NORMAL,		// Gib if entity was overkilled
